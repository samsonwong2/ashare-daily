...
from decision_pack.src.extreme_drop_override import enrich_oos_from_ohlcv_loader
...
from decision_pack.src.regime_transition_trade_bias import load_trade_bias_predictions
from decision_pack.src.regime_transition_bias_promotion import (
    default_promotion_path,
    load_bias_promotion,
)
from decision_pack.src.indicators import ma20_trend_state
...
from pipeline.price_adjustments import (
...
def annotate_regime_overlays(
    ...
    *,
    ...
    from decision_pack.src.adaptive_stage_common import _apply_title_top_margin
