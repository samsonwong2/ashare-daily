...
from ashare_daily.lib.fair_path_band_signals import find_regime_html  # noqa: E402
...
def _load_sm():
    from ashare_daily.plots import run_reusable_extrema_state_machine as mod
