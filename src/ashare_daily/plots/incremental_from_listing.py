...
from ashare_daily.lib.fair_path_band_signals import (
    FIG_PANELS,
...
def _expected_trails(extra_trail_years: str | None) -> list[float]:
    from ashare_daily.plots.plot_regime_transition_example import (
...
def extract_layout(html: str) -> dict[str, Any]:
    from ashare_daily.plots.overlay_oracle_pivots_on_regime_html import (
...
def _fig1_5_last_values(
    ...
    *,
    ...
    from ashare_daily.lib.regime_transition_plot import compute_volatility_regime_frame
...
def _extend_fig15_ref_lines(traces: list[dict[str, Any]], new_ts: pd.Timestamp) -> None:
    from ashare_daily.lib.vol_need_return_board import EQUITY_ANCHOR_LABEL
...
def _append_fig1_5_overlays(
    ...
    *,
    ...
    from ashare_daily.lib.vol_need_return_board import ANCHOR_ERP_ANN, EQUITY_ANCHOR_LABEL
...
def try_incremental_html(
    *,
    ...
    from ashare_daily.lib.ewma_fair_rails import attach_ewma_rails
...
def write_book_csvs(
    *,
    ...
    import numpy as np
    from ashare_daily.plots.adaptive_stage_common import (
        FIXED_HYBRID_RULES,
    ...
    from ashare_daily.lib.early_down_alert import detect_early_down_marks
    from ashare_daily.lib.early_down_alert import early_down_flags_frame
    from ashare_daily.hrp.hrp_cluster_router import mode_allows_trade_overlay
    from ashare_daily.plots.recovery_up_overlay import (
        DIAGNOSTIC_N,
        SHALLOW_N,
    ...
    from ashare_daily.plots.self_train_policy import (
