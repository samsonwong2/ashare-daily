...
from ashare_daily.plots.backtest_beat_or_hold_513650 import (  # noqa: E402
    _load_mod,
    apply_new_veto,
    collect_tickets,
    load_symbol_config,
...
from ashare_daily.plots.adaptive_stage_common import prepare_features  # noqa: E402
from ashare_daily.lib.garch_dynamics import GarchDynamicsConfig  # noqa: E402
from ashare_daily.lib.garch_short_horizon_board import GarchShortHorizonConfig  # noqa: E402
from ashare_daily.lib.vol_need_return_board import TARGET_SHARPE_LIKE  # noqa: E402
...
def load_panel_and_regimes(
    ...
    *,
    ...
    from ashare_daily.plots import plot_regime_transition_example as pm
    from ashare_daily.regime import eval_causal_regime_switch_pool as ev
    pm._init_qlib(None)
