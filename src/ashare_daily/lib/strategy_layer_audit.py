...
from ashare_daily.paths import ALL_INSTRUMENTS_TXT, CLUSTER_MAPPING_SELECTED_TXT, FUND_LIST_CSV, QLIB_PROVIDER_URI, TEMP_DIR
...
def run_l3_for_full_mvo(
    ...
    from ashare_daily.lib.risk_controls import apply_risk_controls
